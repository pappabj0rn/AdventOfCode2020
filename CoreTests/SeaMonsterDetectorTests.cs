...
namespace CoreTests
{
    public abstract class SeaMonsterDetectorTests
    {
        public class BuildRules
        {
            ...
            [Fact]
            public void Should_set_up_referenced_rules()
            {
                var inputs = new[]
                {
                    "0: 1 2",
        ...
        private static readonly string[] PuzzleRulesInput =
        {
            "120: \"b\"",
            "117: 120 51 | 2 10",
            "37: 120 96 | 2 94",
        ...
        private static readonly string[] PuzzleDataInput =
        {
